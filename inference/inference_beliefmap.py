...
class DopeNode(object):
    ...
    def image_callback(
        ...
        # Detect object
        results, belief_map = ObjectDetector.detect_object_in_image(
            self.model.net, self.pnp_solver, img, self.config_detect, True
        )
        ...
        belief_map.save(os.path.join(
            output_path, ".".join(img_name_base.split(".")[:-1]) + "_bm.png"))
